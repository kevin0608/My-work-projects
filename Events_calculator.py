...
class Event:
    def __init__(self, event_name, event_type, guests, food_hours, food_rate, clearing_hours, clearing_rate, wine_hours, wine_rate, bartender_hours, bartender_rate, cloakroom_hours, cloakroom_rate):
        self.name = event_name
        self.type = event_type
        self.guests = guests
        self.food_hours = food_hours
        self.food_rate = food_rate
        self.clearing_hours = clearing_hours
        self.clearing_rate = clearing_rate
    ...
    def calculate_staff(self):
            ...
            self.total_staff_combined = sum([self.num_food_staff, self.num_clearing_staff, 
    ...
    def calculate_staff_cost(self):
            ...
            self.food_service_staff_cost = round(self.num_food_staff * self.food_rate * self.food_hours, 2)
            self.clearing_staff_cost = round(self.num_clearing_staff * self.clearing_rate * self.clearing_hours, 2)
            ...
            self.cloakroom_staff_cost = round(self.num_cloakroom_staff * self.cloakroom_rate * self.cloakroom_hours, 2)
            self.total_staff_cost = round(sum([self.food_service_staff_cost, self.clearing_staff_cost,
...
class App:
    def __init__(self, root):
        self.root = root
        self.root.title('Agency Calculator')
        self.create_widgets()
        self.events = []
    ...
    def clear_fields(self):
        ...
        self.clearing_hours_entry.delete(0, tk.END)
        ...
        self.clearing_rate_entry.delete(0, tk.END)
    ...
    def create_widgets(self):   
        ...
        self.event_frame.grid(rowspan= 2, columnspan=4)
        ...
        self.event_type_entry = tk.Entry(self.event_frame, width=15)
        ...
        self.clearing_hours_label = tk.Label(self.event_frame, text="Clearing Staff Hours:")
        self.clearing_hours_label.grid(row=4, column=0)
        self.clearing_hours_entry = tk.Entry(self.event_frame, width=15)
        self.clearing_hours_entry.grid(row=4, column=1)

        self.clearing_rate_entry = tk.Entry(self.event_frame, width=5)
        self.clearing_rate_entry.grid(row=4, column=2)
        ...
        self.clear_button = tk.Button(self.event_frame, text="Clear", command=self.clear_fields, bg="red")
        ...
        self.output_text = tk.Text(root,height=40, width=60, font=("Helvetica", 14))
    ...
    def validate_event_type(self):
        event_type = self.event_type_entry.get().upper()
        if event_type not in ['RECEPTION', 'DDR BOWL', 'DDR BUFFET']:
            self.output_text.insert(tk.END, 'Event type must be one of the following: reception, ddr bowl or ddr buffet\n', 'red')
            # Return False to indicate that the event type is invalid
            return False
        # Return True to indicate that the event type is valid
        return True
    ...
    def calculate_expenses(self):   
        ...
        # Stop further execution if event type is invalid
            return 
        ...
        if event_type == 'DDR BOWL' or event_type == 'DDR BUFFET':
            ...
            try:
                ...
                clearing_hours_entry = self.clearing_hours_entry.get()
                if not clearing_hours_entry:
                    raise ValueError('Clearing hours entry is missing')
                clearing_hours = validate_numeric_input(clearing_hours_entry)
                if clearing_hours is None:
                    raise ValueError('Clearing hours must be numeric')
                ...
                clearing_rate_entry = self.clearing_rate_entry.get()
                if not clearing_rate_entry:
                    raise ValueError("Clearing rate entry is missing")
                clearing_rate = validate_numeric_input(clearing_rate_entry)
                if clearing_rate is None:
                    raise ValueError("Clearing rate must be numeric")
            ...
            event = Event(event_name, event_type, guests, food_hours, food_rate, clearing_hours, clearing_rate, wine_hours, wine_rate, bartender_hours, bartender_rate, cloakroom_hours, cloakroom_rate)
            self.events.append(event)
            ...
            # Calculate total staffing cost by category
            food_service_staff_cost = event.food_service_staff_cost
            clearing_staff_cost = event.clearing_staff_cost
            ...
            self.total_food_service_staff_cost += food_service_staff_cost
            self.total_clearing_staff_cost += clearing_staff_cost
            ...
            self.output_text.insert(tk.END, f'Food Waiter Hours: {food_hours} @ £ {food_rate}\n','orange')
            self.output_text.insert(tk.END, f'Clearing Staff Hours: {clearing_hours} @ £ {clearing_rate}\n','orange')
            ...
            self.output_text.insert(tk.END, f'Food Waiter: {num_food_staff}\n', 'green')
            self.output_text.insert(tk.END, f'Clearing: {num_clearing_staff}\n', 'green')
            ...
            self.output_text.insert(tk.END, f'Food Waiter: £ {food_service_staff_cost}\n', 'red')
            self.output_text.insert(tk.END, f'Clearing: £ {clearing_staff_cost}\n', 'red')
    ...
    def total_reports(self):
        ...
        self.output_text.insert(tk.END, f'Total Clearing Staff: {self.total_clearing_staff_combined}\n','green')
        ...
        self.output_text.insert(tk.END, f'Total Food Waiter Cost: £ {self.total_food_service_staff_cost}\n','red')
        self.output_text.insert(tk.END, f'Total Clearing Staff Cost: £ {self.total_clearing_staff_cost}\n','red')
        self.output_text.insert(tk.END, f'Total Wine Waiter Cost: £ {self.total_wine_waiters_staff_cost}\n','red')
        self.output_text.insert(tk.END, f'Total Bartender Staff Cost: £ {self.total_bartender_staff_cost}\n','red')
        self.output_text.insert(tk.END, f'Total Cloakroom Cost: £ {self.total_cloakroom_staff_cost}\n\n','red')   
