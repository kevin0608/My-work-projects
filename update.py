...
The 'event type' must be one of the following to ensure correct calculation based on specific conditions:
                                               " Reception, DDR bowl, DDR buffet " 
For ddr 'event type', only fill in necessary entry fields: 
                                        " Food waiter, Cloakroom and DDR Meeting Rooms "\n\n""", "yellow")
    ...
    def create_widgets(self):   
        ...
        self.event_frame.grid(rowspan= 2, columnspan=1)
        ...
        self.Phasu.grid(row=8, column=5)
        ...
        self.clear_button = tk.Button(self.event_frame, text="Clear", command=self.clear_fields, padx=30)
        ...
        self.output_text = tk.Text(root,height=40, width=60, font=("Helvetica", 10),bg="#1e1e1e")
